...
- **Panel**: click the `⇄ Switch panel` button in the Claude Code card's top-right corner to switch panel styles. v0.6 ships with five built-in panels — **Classic** (clean light cards), **Matrix** (black background, neon green type, falling digital rain), **Windows 95** (retro Win95 interface: teal desktop, navy title bars, 3D grey windows), **Newspaper** (aged newsprint: serif ink type, double-rule borders, newspaper-style section headings), and **Cloud Observation** (weather-station style: light blue sky gradient, SVG cloud layers, contour lines, translucent glass cards).
  ...
  <p align="center">
    ...
    &nbsp;&nbsp;
    <img src="docs/cloud_observation.en.png" alt="cloud observation panel" width="320">
  </p>
