...
REPORT_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "model": "模型",
        "model_section": "主力模型",
        "narrative": "過去這段時間你燒了 {tokens} tokens、跨 {projects} 個專案。{peak_date} 是高峰（{peak_tokens}/天），主力 LLM 是 {top_model}。",
        "period": "區間",
        "project": "專案",
    ...
    "zh-CN": {
        ...
        "model": "模型",
        "model_section": "主力模型",
        "narrative": "过去这段时间你烧了 {tokens} tokens、跨 {projects} 个项目。{peak_date} 是高峰（{peak_tokens}/天），主力 LLM 是 {top_model}。",
        "period": "区间",
        "project": "项目",
    ...
    "en": {
        ...
        "narrative": "You burned {tokens} tokens across {projects} projects. Peak was {peak_date} ({peak_tokens}/day). Top model: {top_model}.",
        "period": "Period",
        "project": "Project",
    ...
    "ja": {
        ...
        "model": "モデル",
        "model_section": "主力モデル",
        "narrative": "この期間に {tokens} tokens を使い、{projects} 件のプロジェクトを横断しました。ピークは {peak_date}（{peak_tokens}/日）。主力モデル：{top_model}。",
        "period": "期間",
        "project": "プロジェクト",
    ...
    "ko": {
        ...
        "model": "모델",
        "model_section": "주력 모델",
        "narrative": "이 기간 동안 {tokens} tokens를 사용했고, {projects}개 프로젝트에 걸쳐 있습니다. 최고점은 {peak_date}({peak_tokens}/일). 주력 모델: {top_model}.",
        "period": "기간",
        "project": "프로젝트",
